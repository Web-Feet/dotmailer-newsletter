...
class DotmailerNewsletterWidget extends WP_Widget {
	...
	public function widget( $args, $instance )
	{
		...
		<form name="dotmailer-subscribe" id="dotmailer-subscribe" method="post" action="<?php echo get_site_url() ?>/wp-content/plugins/dotmailer-newsletter/dotmailer-newsletter-subscribe.php">
...
wp_enqueue_script('dotmailer AJAX', '/wp-content/plugins/dotmailer-newsletter/js/dotmailer-ajax.js', array('jquery'));
