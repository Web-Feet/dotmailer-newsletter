...
require( 'dotmailer-newsletter-widget.php' );

class DotmailerNewsletterSettingsPage {
	/**
...
if( is_admin() ) {
    $my_settings_page = new DotmailerNewsletterSettingsPage();
}